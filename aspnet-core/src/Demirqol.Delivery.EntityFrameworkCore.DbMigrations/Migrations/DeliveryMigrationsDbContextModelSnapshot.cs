...
{
    [DbContext(typeof(DeliveryMigrationsDbContext))]
    partial class DeliveryMigrationsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Demirqol.Delivery.ItemManagement.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MD_Category");
                });

            modelBuilder.Entity("Demirqol.Delivery.ItemManagement.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Demirqol.Delivery.MarketManagement.Market", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Demirqol.Delivery.OrderManagement.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Demirqol.Delivery.OrderManagement.OrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OP_OrderLine");
                });

            modelBuilder.Entity("Demirqol.Delivery.Users.UserPosition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Demirqol.Delivery.OrderManagement.OrderLine", b =>
                {
                    b.HasOne("Demirqol.Delivery.OrderManagement.Order", null)
                        .WithMany("OrderLines")
